!function(t, o) {
    ...
    function r(t, o) {
        return !(!t || "string" != typeof o) && !!(t.className && -1 < t.className.trim().split(/\s+/gi).indexOf(o))
    }
    return o.lib = o.prototype = {
        ...
        init: function(t) {
            ...
            this.options.gravity = "bottom" == t.gravity ? "toastify-bottom" : "toastify-top",
            ...
            this.options.stopOnFocus = void 0 === t.stopOnFocus || t.stopOnFocus,
            this
        },
        buildToast: function() {
            if (!this.options)
                throw "Toastify is not initialized";
            var t, o, i, e = document.createElement("div");
            return e.className = "toastify on " + this.options.className,
            ...
            this.options.backgroundColor && (e.style.background = this.options.backgroundColor),
            e.innerHTML = this.options.text,
            "" !== this.options.avatar && ((i = document.createElement("img")).src = this.options.avatar,
            i.className = "toastify-avatar",
            "left" == this.options.position || !0 === this.options.positionLeft ? e.appendChild(i) : e.insertAdjacentElement("beforeend", i)),
            !0 === this.options.close && ((t = document.createElement("span")).innerHTML = "&#10006;",
            ...
            .bind(this)),
            this.options.stopOnFocus && 0 < this.options.duration && (o = this,
            ...
            ("left" == this.options.position || !0 === this.options.positionLeft) && 360 < i ? e.insertAdjacentElement("afterbegin", t) : e.appendChild(t)),
            void 0 !== this.options.destination && e.addEventListener("click", function(t) {
                t.stopPropagation(),
        ...
        showToast: function() {
            ...
            !(t = void 0 === this.options.selector ? document.body : document.getElementById(this.options.selector)))
                throw "Root element is not defined";
            return t.insertBefore(this.toastElement, t.firstChild),
            o.reposition(),
            0 < this.options.duration && (this.toastElement.timeOutValue = window.setTimeout(function() {
    ...
    o.reposition = function() {
        for (var t = {
            ...
            top: 15,
            bottom: 15
        }, e = document.getElementsByClassName("toastify"), s = 0; s < e.length; s++) {
            a = !0 === r(e[s], "toastify-top") ? "toastify-top" : "toastify-bottom";
            var n = e[s].offsetHeight
              , a = a.substr(9, a.length - 1);
            (0 < window.innerWidth ? window.innerWidth : screen.width) <= 360 ? (e[s].style[a] = i[a] + "px",
            i[a] += n + 15) : !0 === r(e[s], "toastify-left") ? (e[s].style[a] = t[a] + "px",
            t[a] += n + 15) : (e[s].style[a] = o[a] + "px",
            o[a] += n + 15)
        }
        return this
    }
