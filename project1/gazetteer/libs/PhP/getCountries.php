...
// $api = 'http://api.geonames.org/neighboursJSON?formatted=true&country=' . $_REQUEST['country'] . '&username=bvlaal&style=full';
$api = 'http://api.geonames.org/searchJSON?formatted=true&q=' . $_REQUEST['airport'] . '&country='. $_REQUEST['country'] . '&maxRows=20&lang=en&username=bvlaal&style=full';
